...
| `sources/#2.1-reino-de-durnvale.md` | Material bruto copiado para `sources/` | canônico ativo | Bruto preservado; conteúdo ativo migrado | `world/public/geography/central/realms/durnvale/index.md` | Fonte oficial de Durnvale. | Conflita com `#2.1-reino-de-durunvale.md`; grafia oficial definida como Durnvale. |
