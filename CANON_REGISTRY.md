...
4. `sources/vaelyndor.md` é fonte canônica dedicada do reino costeiro menor de
   Vaelyndor, derivada do compilado e compatibilizada com Aurathil.
5. `sources/torres-de-marfim.md` é fonte própria da instituição.
6. Os arquivos individuais dos reinos continuam fontes primárias de seus
...
| `sources/MAPA-CONTINENTAL.json`                   | índice espacial derivado       | Referência analítica derivada; preservado e não canônico                                                                                  | `docs/governance/continental-map-reference.md`                                                                                                       |
...
| `sources/vaelyndor.md`                            | canônico ativo consolidado     | Fonte canônica dedicada de Vaelyndor; derivada de `sources/outros-lugares.md`; nenhuma camada privada de mestre criada nesta consolidação | `world/public/geography/north/realms/vaelyndor/index.md`                                                                                             |
