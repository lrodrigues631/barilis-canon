...
| `sources/#2.3-reino-de-thalendor-atualizado.md` | canônico ativo primário        | Fonte consolidada de Thalendor; bruto preservado; substitui versões anteriores                   | `world/public/geography/central/realms/thalendor/`                                                                                        |
