...
| `sources/#2.1-reino-de-durnvale.md`             | canônico ativo                 | Migrado para `world/public/geography/central/realms/durnvale/index.md`; bruto preservado | `world/public/geography/central/realms/durnvale/index.md`   |
...
| `sources/#2.3-reino-de-thalendor.md`            | canônico ativo                 | Preservado bruto                                                                         | `world/public/geography/central/realms/thalendor/`          |
| `sources/#2.4-reino-durundralin.md`             | canônico ativo                 | Preservado bruto                                                                         | `world/public/geography/north-central/realms/durundralin/`  |
