...
| 9     | `sources/#2.6-reino-de-owill-atualizado.md`       | Fonte consolidada nesta etapa; migrar futuramente o conteúdo público para `world/public/geography/south/realms/owill/`, mantendo `#2.6-reino-owill.md` como histórico/substituído.                                       |
...
| `world/public/geography/south/realms/owill/`                                     | Conteúdo canônico público de `#2.6-reino-de-owill-atualizado.md`                              |
