...
| 7     | `sources/#2.5-reino-de-jotungard-atualizado.md`   | Dividido nesta etapa entre `world/public/geography/north/realms/jotungard/index.md` e `world/private/geography/north/realms/jotungard/segredos-das-geadas.md`; manter bruto preservado em `sources/`.                    |
