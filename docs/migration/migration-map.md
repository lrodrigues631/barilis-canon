...
| 10    | `sources/outros-lugares.md`                       | Fenrir's Hollow, Silverglen, Emberfall, Everbright, Frostholm e Dawnwood migrados de forma pública e mínima para `world/public/geography/north/places/`; demais lugares menores e relações regionais permanecem para etapas futuras; usar como substituto das listas antigas.               |
