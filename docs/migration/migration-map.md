...
| 4     | `sources/#2.2-reino-de-irtuman-atualizado.md`     | Consolidado nesta etapa como fonte primária; migrar futuramente para `world/public/geography/south/realms/irtuman/`; manter bruto preservado em `sources/`.                                                              |
...
| 9     | Arquivos individuais de reinos restantes          | Migrar cada território para a pasta geográfica correspondente.                                                                                                                                                           |
...
| `world/public/geography/south/realms/irtuman/`                                   | `#2.2-reino-de-irtuman-atualizado.md`                                                         |
