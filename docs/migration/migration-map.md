...
| 6     | `sources/#2-reino-aurathil-atualizado.md`         | Consolidado nesta etapa como fonte primária; migrar futuramente para `world/public/geography/north/realms/aurathil/`.                                                                                                    |
| 7     | Arquivos individuais de reinos restantes          | Migrar cada território para a pasta geográfica correspondente.                                                                                                                                                           |
| 8     | `sources/outros-lugares.md`                       | Migrar lugares menores e relações regionais; usar como substituto das listas antigas.                                                                                                                                    |
| 9     | `sources/torres-de-marfim.md`                     | Migrar como instituição própria, sem absorver em região.                                                                                                                                                                 |
| 10    | `sources/uldain.md`                               | Migrar como `aguas-de-uldain`, com nome exibido Águas de Uldain e alias Uldain, após split de visibilidade e escopo.                                                                                                     |
| 11    | `sources/economia_barilis.md`                     | Separar contexto econômico canônico de diretrizes operacionais de mestre antes de migrar.                                                                                                                                |
| 12    | `sources/orientation_project_barilis.md`          | Extrair apenas regras permanentes aprovadas para `docs/governance/`; não migrar para `world/`.                                                                                                                           |
| 13    | Arquivos fora do escopo                           | Manter fora de `world/`; avaliar `barilis-master`, remoção ou documentação externa.                                                                                                                                      |
...
| `world/public/geography/north/realms/aurathil/`                                  | `#2-reino-aurathil-atualizado.md`                                                             |
