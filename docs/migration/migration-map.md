...
| 6     | `sources/#2-reino-aurathil-atualizado.md`         | Dividido nesta etapa entre `world/public/geography/north/realms/aurathil/index.md` e `world/private/geography/north/realms/aurathil/segredos-e-intrigas.md`; manter bruto preservado em `sources/`.                      |
| 7     | `sources/#2.5-reino-de-jotungard-atualizado.md`   | Consolidado nesta etapa como fonte primária; migrar futuramente para `world/public/geography/north/realms/jotungard/`; manter bruto preservado em `sources/`.                                                            |
| 8     | Arquivos individuais de reinos restantes          | Migrar cada território para a pasta geográfica correspondente.                                                                                                                                                           |
| 9     | `sources/outros-lugares.md`                       | Migrar lugares menores e relações regionais; usar como substituto das listas antigas.                                                                                                                                    |
| 10    | `sources/torres-de-marfim.md`                     | Migrar como instituição própria, sem absorver em região.                                                                                                                                                                 |
| 11    | `sources/uldain.md`                               | Migrar como `aguas-de-uldain`, com nome exibido Águas de Uldain e alias Uldain, após split de visibilidade e escopo.                                                                                                     |
| 12    | `sources/economia_barilis.md`                     | Separar contexto econômico canônico de diretrizes operacionais de mestre antes de migrar.                                                                                                                                |
| 13    | `sources/orientation_project_barilis.md`          | Extrair apenas regras permanentes aprovadas para `docs/governance/`; não migrar para `world/`.                                                                                                                           |
| 14    | Arquivos fora do escopo                           | Manter fora de `world/`; avaliar `barilis-master`, remoção ou documentação externa.                                                                                                                                      |
...
| `world/public/geography/north/realms/jotungard/`                                 | `#2.5-reino-de-jotungard-atualizado.md`                                                       |
