...
| 10.3  | `sources/floresta-de-sharpentrees.md`             | Conteúdo público migrado para `world/public/geography/north/places/floresta-de-sharpentrees/index.md`; conteúdo privado regional migrado para `world/private/geography/north/places/floresta-de-sharpentrees/segredos-da-nevoa.md`; organização privada e NPCs regionais permanecem pendentes de etapas próprias. |
...
| `world/private/organizations/sussurros-da-floresta.md`                               | Organização privada registrada em `sources/floresta-de-sharpentrees.md`; pendente de migração própria |
| `world/private/npcs/north/sharpentrees/`                                             | NPCs locais registrados em `sources/floresta-de-sharpentrees.md`; pendentes de migração própria       |
