...
| 10.1  | `sources/vaelyndor.md`                            | Fonte canônica dedicada criada nesta etapa; migrar futuramente para `world/public/geography/north/realms/vaelyndor/index.md`; nenhuma camada privada de mestre foi criada nesta consolidação.                            |
...
| `world/public/geography/north/realms/vaelyndor/index.md`                         | `sources/vaelyndor.md`                                                                        |
