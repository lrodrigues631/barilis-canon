...
| Águas de Uldain                  | Local natural        | Norte de Barilis; marco em Sharpentrees no compilado e local próprio consolidado em `sources/uldain.md` | `sources/uldain.md`                                      | As Águas de Uldain                             | Fase 3 — migração com separação entre conteúdo público, segredo permanente de mestre e material tático | fora do escopo da Fase 2     |
...
- **Aurathil, Vaelyndor, Sharpentrees, Emberfall, Everbright e Dawnwood:**
  ...
  vila, não reino.
- **Águas de Uldain:** possui fonte consolidada própria em `sources/uldain.md`.
  Sua migração permanece reservada à Fase 3, pois exige separação entre lore
  público, segredos permanentes de mestre e material tático.
