...
| Bryndor                                            | Reino menor      | Região Central; campos férteis e florestas, a oeste das Montanhas de DurunDralin                  | `sources/outros-lugares.md`                                | Centro-leste, entre DurunDralin e Eldewood                   | Migrado como reino menor público em `world/public/geography/central/realms/bryndor/index.md`     | migrado como página mínima   |
...
| Vila Gorrukh                                       | Vila             | Sudoeste de Eldewood                                                                              | `sources/outros-lugares.md`                                | Próxima de Eldewood                                          | Migrada como lugar público mínimo em `world/public/geography/central/places/gorrukh/index.md`    | migrado como página mínima   |
