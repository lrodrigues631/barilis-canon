...
| Vale dos Últimos Suspiros                          | Marco regional   | Sudeste de Bryndor, nos pés das Montanhas de DurunDralin, ao norte do Pântano de Elanor                                                                                                     | `world/public/index.md`                                    | Não discriminado no JSON                                     | Página própria pendente na Fase 2 em `world/public/geography/central/places/vale-dos-ultimos-suspiros/` | pendente de página própria   |
| Pântano de Elanor                                  | Pântano          | Norte de Hollowmist e oeste de Bryndor; Ruínas de Varthaal ficam entre Bryndor e o pântano                                                                                                  | `sources/outros-lugares.md`                                | Pântano de Elanor                                            | Página própria pendente na Fase 2 em `world/public/geography/central/places/pantano-de-elanor/`         | pendente de página própria   |
...
| Santuário do Vento Eterno                          | Marco            | Sudoeste do Abismo de Hollowmist, nos picos ocidentais da Região Central; Santuário do Vento é variação anterior da fonte                                                                   | `sources/outros-lugares.md`                                | Santuário do Vento Eterno                                    | Página própria pendente na Fase 2 em `world/public/geography/central/places/santuario-do-vento-eterno/` | pendente de página própria   |
...
| Ruínas de Varthaal                                 | Ruínas           | Entre Bryndor e o Pântano de Elanor; oeste/sudoeste de Bryndor e sudeste do Pântano de Elanor                                                                                               | `sources/outros-lugares.md`                                | Marco próximo de Bryndor                                     | Página própria pendente na Fase 2 em `world/public/geography/central/places/ruinas-de-varthaal/`        | pendente de página própria   |
| As Torres de Cinza                                 | Ruínas           | Sul-sudeste de Bryndor e noroeste de Gorrukh                                                                                                                                                | `sources/outros-lugares.md`                                | Marco próximo de Bryndor                                     | Página própria pendente na Fase 2 em `world/public/geography/central/places/torres-de-cinza/`           | pendente de página própria   |
| Círculo de Espinhos                                | Marco ritual     | Sul-sudoeste das Torres de Cinza; dentro ou imediatamente ao sul da Floresta Negra de Eldewood                                                                                              | `sources/outros-lugares.md`                                | Marco próximo de Eldewood                                    | Página própria pendente na Fase 2 em `world/public/geography/central/places/circulo-de-espinhos/`       | pendente de página própria   |
| O Bosque das Sombras Mudas                         | Bosque           | Norte e oeste de Hollowmist                                                                                                                                                                 | `sources/outros-lugares.md`                                | Marco próximo de Hollowmist                                  | Página própria pendente na Fase 2 em `world/public/geography/central/places/bosque-das-sombras-mudas/`  | pendente de página própria   |
| Abismo de Hollowmist                               | Marco            | Sul de Hollowmist                                                                                                                                                                           | `sources/outros-lugares.md`                                | O Abismo de Hollowmist                                       | Página própria pendente na Fase 2 em `world/public/geography/central/places/abismo-de-hollowmist/`      | pendente de página própria   |
...
| Feira dos Pactos Perdidos                          | Local/evento     | Ocorre em vilarejo itinerante sem nome próprio definido, a sul-sudeste das Torres de Marfim; Feira dos Pactos Proibidos e Praia dos Pactos Proibidos são variações antigas de fonte ou mapa | `sources/outros-lugares.md`                                | A Praia dos Pactos Proibidos                                 | Página própria pendente na Fase 2 em `world/public/geography/central/places/feira-dos-pactos-perdidos/` | pendente de página própria   |
...
- **Eldewood, Hollowmist e Gorrukh:** migrados como lugares públicos mínimos a
  partir de `sources/outros-lugares.md`, sem conteúdo privado ou desenvolvimento
  adicional; marcos associados da Região Central permanecem pendentes para lotes
  futuros.
